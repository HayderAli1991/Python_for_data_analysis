...
A merchant selling goods on Amazon wants a small analysis to be done. On the amazon portal, they export their sales data called sales_data.xlsx.
...
Total Sales by Fulfilment and Shipment Type They would like the last two tables exported to send to their investors.
